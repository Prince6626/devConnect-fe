    ...
    return (
      <div className="min-h-screen bg-[#121212] flex items-center justify-center p-8">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-white mb-4">No Connections Yet</h1>
          <p className="text-gray-400 text-lg">Start connecting with other developers to build your network!</p>
        </motion.div>
      </div>
    );
  }
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-gray-300 font-medium">{connections.length} Connections</span>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {connections.map((connection, index) => {
            const { _id, firstName, lastName, about, photoUrl, skills } = connection;
